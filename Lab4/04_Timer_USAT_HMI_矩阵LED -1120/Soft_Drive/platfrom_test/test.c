...
uint8_t row[]      = {0x7F,0x49,0x49,0x49,0x49,0x7F,0x0,0x0};				//整个字
...
uint8_t core1[]    = {0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f};				  //第一笔画

uint8_t row2[]     = {0x7F,0x1,0x1,0x1,0x1,0x1,0x0,0x0};
uint8_t core2[]    = {0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f}; 				//第二笔画

uint8_t row3[]     = {0x7F,0x1,0x1,0x1,0x1,0x7F,0x0,0x0};
uint8_t core3[]    = {0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f}; 				//第三笔画

uint8_t row4[]     = {0x7F,0x9,0x9,0x9,0x9,0x7F,0x0,0x0};
uint8_t core4[]    = {0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f}; 				//第四笔画
