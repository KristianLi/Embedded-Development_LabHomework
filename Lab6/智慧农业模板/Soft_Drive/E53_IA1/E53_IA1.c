...
void E53_IA1_I2C_Master_Transmit(uint8_t slaveAddr, uint8_t *pBuffer, uint8_t NumByteToRead)
{
    ...
    while (!i2c_flag_get(I2C0, I2C_ADDSEND))
        ;
    /* clear ADDSEND bit */
    i2c_flag_clear(I2C0, I2C_ADDSEND);
    ...
    {
        /* data transmission */
        i2c_transmit_data(I2C0, pBuffer[i]);
...
void Init_Motor(void)
{
    ...
    /* configure led GPIO port */
		gpio_mode_set(IA1_Motor_GPIO_Port, GPIO_MODE_OUTPUT , GPIO_PUPD_PULLUP, IA1_Motor_Pin);
		gpio_output_options_set(IA1_Motor_GPIO_Port, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, IA1_Motor_Pin);		
...
void Init_Light(void)
{
    ...
    /* configure led GPIO port */
		gpio_mode_set(IA1_Light_GPIO_Port, GPIO_MODE_OUTPUT , GPIO_PUPD_PULLUP, IA1_Light_Pin);
		gpio_output_options_set(IA1_Light_GPIO_Port, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, IA1_Light_Pin);	
