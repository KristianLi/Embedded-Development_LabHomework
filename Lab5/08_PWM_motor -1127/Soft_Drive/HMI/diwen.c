...
//#define urt5Rec5A_Flag                       BIT_ADDR((uint32_t)&byUart5RecState,0)//����1���ݽ��յ�5A��־
//#define urt5RecStart_Flag                    BIT_ADDR((uint32_t)&byUart5RecState,1)//����1���ݽ���������ͷ��־
//#define urt5RecEnd_Flag                      BIT_ADDR((uint32_t)&byUart5RecState,2)//����1������ɱ�־
//#define urt5RecData_Flag                     BIT_ADDR((uint32_t)&byUart5RecState,3)//����1�����ݽ��ձ�־
...
void USART5_IRQHandler(void) {
		...
		if (SET==usart_interrupt_flag_get(USART5, USART_INT_RBNEIE)) //���ָ����TIM�жϷ������:TIM �ж�Դ 
		{
	unsigned char t=0;
	for(t=0;t<9;t++)
			{				
...
//  uint8_t tempdata=0;
//   /***********************************����1�������ݴ�������****************************************/	
//   if(RESET != usart_interrupt_flag_get(USART5, USART_INT_RBNEIE))   //����1�����ж�	
//   {
// 
//    usart_flag_clear(USART5, USART_FLAG_RBNE);	 
//	 // Uart1RecTimerOut=200;  
//	uart5RecData_Flag=1;//���������ݽ��ձ�־��1 
//	  tempdata=usart_data_receive(USART5);
//	  if(uart5RecStart_Flag)//������յ�������ͷ��־
//	  {
//         Uart5RecBuff[Uart5RecDataBuffLength]=tempdata; 
//         Uart5RecDataBuffLength++;
//		 if(Uart5RecDataBuffLength>0)
//		 {
//		    uart5tempreclength=Uart5RecBuff[0];//��ȡ���ݽ��ճ���
//			if(Uart5RecDataBuffLength>uart5tempreclength)//���ݽ������
//			{
...
//			}
//         }	
//		 if(Uart5RecDataBuffLength>=20)//�������1���������������,����ճ���Ϊ0
//		 {
//			Uart5RecDataBuffLength=0;
//		 }	
//      }
